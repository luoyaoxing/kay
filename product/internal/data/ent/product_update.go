...
func (pu *ProductUpdate) SetAge(i int) *ProductUpdate {
...
func (pu *ProductUpdate) AddAge(i int) *ProductUpdate {
...
// SetAge sets the "age" field.
func (puo *ProductUpdateOne) SetAge(i int) *ProductUpdateOne {
...
// AddAge adds i to the "age" field.
func (puo *ProductUpdateOne) AddAge(i int) *ProductUpdateOne {
